...
TB_hamp_list = []
for date in dates:
    TB_arts_list.append(pd.read_csv(f"Data/arts_calibration/HALO-{date}a/TBs_arts.csv", index_col=0))
    TB_hamp_list.append(pd.read_csv(f"Data/arts_calibration/HALO-{date}a/TBs_hamp.csv", index_col=0)) 
