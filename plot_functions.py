...
def hamp_ql(ds_radar_lev1, ds_11990_lev1, ds_183_lev1, ds_kv_lev1, timeframe, figsize=(10, 14)):
    """
    ...
    _plot_radiometer(ds_183_lev1["TBs"].sel(time=timeframe), axes[5])
...
def produce_hourly_hamp_ql(ds_radar_lev1, ds_11990_lev1, ds_183_lev1, ds_kv_lev1, flightname):
    ...
    for i in range(0, len(timeslices)-1):
        ...
        fig.savefig(f"quicklooks/{flightname}/ql_{timeslices[i].strftime('%Y%m%d_%H%M')}.pdf", bbox_inches='tight')
