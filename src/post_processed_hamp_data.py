class PostProcessedHAMPData:
  def __init__(self, flightdata, radar, radio183, radio11990, radiokv, is_planet=False):
    self.flightdata = flightdata
    self.radar = radar
    self.radio183 = radio183
    self.radio11990 = radio11990
    self.radiokv = radiokv
    self.is_planet = is_planet # False = using bahamas, True = using planet for flightdata
